...
}
{
 ...
 const tmp13 = accumulate(null, 0);
 const tmp14 = toString(tmp13);
 outputAndFlush(stdOut[0], tmp14);
 outputAndFlush(stdOut[0], Uint8Array.of(10));
 const tmp15 = accumulate(_list([1, 2, 3]), 0);
 const tmp16 = toString(tmp15);
 outputAndFlush(stdOut[0], tmp16);
 outputAndFlush(stdOut[0], Uint8Array.of(10));
 const tmp17 = accumulate(_list([Uint8Array.of(102, 111, 111), Uint8Array.of(98, 97, 114), Uint8Array.of(98, 97, 122)]), 0);
