...
}
{
 ...
 let tmp15;
 {
  const tmp16 = isNaN(y);
  if (tmp16) {
   tmp15 = Uint8Array.of(110, 97, 110);
  } else if (y === POSITIVE_INFINITY) {
   tmp15 = Uint8Array.of(105, 110, 102);
  } else if (y === NEGATIVE_INFINITY) {
   tmp15 = Uint8Array.of(126, 105, 110, 102);
  } else {
   const result = ((y.toPrecision(12)).replaceAll("-", "~")).toUpperCase();
   tmp15 = _encodeUtf8(result);
  }
 }
